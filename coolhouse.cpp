...
int main(void)
{
	...
	sfile.open("cool_vert.glsl");
	scon.assign(std::istreambuf_iterator<char>(sfile), std::istreambuf_iterator<char>());
	const char *vertexShaderSource = scon.c_str();
	sfile.close();
	...
	// Getting fragment shader source
	sfile.open("cool_frag.glsl");
	scon.assign(std::istreambuf_iterator<char>(sfile), std::istreambuf_iterator<char>());
	const char *fragmentShaderSource = scon.c_str();
	sfile.close();
